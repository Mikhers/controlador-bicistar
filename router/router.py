...
#=======================================================proveedor================================================================
@bicistar.get("/ver-proveedores",tags=["Proveedor"], response_model=List[Proveedor])
def allProveedores():
    with engine.connect() as conn:
...
@bicistar.post("/insert-new-proveedor", tags=["Proveedor"], status_code=HTTP_201_CREATED)
